...
最近把一个新写的Go项目的日志模块从标准库中的`log`切换到了Google的[glog](https://github.com/golang/glog)。它解决了标准库中很多痛点，如给日志分级，写入文件并切分等。大名鼎鼎的[Kubernetes](https://kubernetes.io/)就是使用它作为日志模块。看了下代码，3个文件，1k多行，于是便仔细阅读了一下源码和大家分享。
...
license: cc-40-by
location: 22, 114
background: https://github.com/golang/go/blob/master/doc/gopher/fiveyears.jpg
tags: [golang, source]
